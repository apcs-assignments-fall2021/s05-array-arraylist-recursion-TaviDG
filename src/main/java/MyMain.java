...
public class MyMain {
    ...
    public static boolean isSorted(ArrayList<Integer> list) {
        // YOUR CODE HERE
        return isSortedTR(list,1,list.get(0));
    }
    public static boolean isSortedTR(ArrayList<Integer> list,int i,int lastNum){

        if (i==list.size()){
            return true;
        }
        else if (list.get(i)<lastNum){
            return false;
        }
        else{ return isSortedTR(list,i+1,list.get(i));}
    }
    // You may want a tail recursive method
